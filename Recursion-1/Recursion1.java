public class Recursion1 {
	...
	*/
	...
	public String changePi(String str) {
	  ...
	  //or just return str.replace("pi","3.14");
	}
	...
	public int countHi2(String str) {
	  ...
	  if(str.substring(len-2,len).equals("hi")){
		if(str.substring(len-3,len-2).equals("x")) return countHi2(str.substring(0,len-1));
	...
	*/
	public String parenBit(String str) {
	  ...
	  if(str.charAt(0)=='(') return parenBit(str.substring(0,len-1));
	  if(str.charAt(len-1)==')') return parenBit(str.substring(1));
	...
	*/
	...
	public int strDist(String str, String sub) {
	  int len = sub.length();
	  if(str.length()==len){
		if(str.equals(sub))return len;
		return 0;
	  }
	  if(str.length()<len) return 0;
	  if(str.substring(0,len).equals(sub) && str.substring(str.length()-len,str.length()).equals(sub)){
		return str.length();
	  }
	  if(str.substring(0,len).equals(sub) && !(str.substring(str.length()-len,str.length()).equals(sub))){
